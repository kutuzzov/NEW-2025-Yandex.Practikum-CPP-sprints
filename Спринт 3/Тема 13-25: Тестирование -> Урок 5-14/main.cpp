...
void TestAreSynonyms() {
    ...
    assert(synonyms.AreSynonyms("music", "melody") == true);
    assert(synonyms.AreSynonyms("tune", "melody") == false);
    assert(synonyms.AreSynonyms("test", "melody") == false);
}

void TestSynonyms() {
    TestAddingSynonymsIncreasesTheirCount();
    TestAreSynonyms();
    cout << "All tests: OK"s << endl;
}
